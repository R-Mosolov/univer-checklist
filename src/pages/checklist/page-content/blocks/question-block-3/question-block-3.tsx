          ...
          <div className="portrait-container">
            <div className="img-container d-flex justify-content-center">
              <img
                className="shadow-sm"
                src={Mendeleev}
                alt="Портрет Д.И. Менделеева"
              />
            </div>
            <h3 className="portrait-name mt-3 text-center">
              Дмитрий Иванович <br className="mobile-break" />
              Менделеев
            </h3>
        ...
        <div className="d-flex align-items-center">
          <form className="form form-container px-4 py-3">
            ...
            <div className="form-group">
              <p className="mt-4">
                3.1. На титульном листе стоят обе подписи (Ваша и научного
                руководителя)?
              </p>
              <input type="radio" id="question-8__answer-1" name="question-8" />
              <span className="margin" />
              <label htmlFor="question-8__answer-1">
                Да, стоят обе подписи
              </label>
              <br />
              <input type="radio" id="question-8__answer-2" name="question-8" />
              <span className="margin" />
              <label htmlFor="question-8__answer-2">Нет</label>
              <br />
            </div>

            <div className="form-group">
              <p className="mt-4">
                3.2. Тема работы написана прописными буквами?
              </p>
              <input type="radio" id="question-9__answer-1" name="question-9" />
              <span className="margin" />
              <label htmlFor="question-9__answer-1">Да</label>
              <br />
              <input type="radio" id="question-9__answer-2" name="question-9" />
              <span className="margin" />
              <label htmlFor="question-9__answer-2">Нет</label>
              <br />
            </div>
            ...
            <div className="form-group">
              ...
              <input
                type="radio"
                id="question-10__answer-1"
                name="question-10"
              />
              <span className="margin" />
              <label htmlFor="question-10__answer-1">Да</label>
              <br />
              <input
                type="radio"
                id="question-10__answer-2"
                name="question-10"
              />
              <span className="margin" />
              <label htmlFor="question-10__answer-2">Нет</label>
              <br />
            </div>
