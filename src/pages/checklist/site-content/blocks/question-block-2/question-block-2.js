          ...
          <div className="portrait d-flex justify-content-center align-items-center">
            <div className="portrait-container">
              ...
              <h3 className="portrait-name mt-3 text-center">
                Константин Эдуардович <br className="mobile-break" />
                Циолковский
              </h3>
              <p className="portrait-description text-center">
                Отец российской <br className="mobile-break" />
          ...
          <div className="form-container d-flex justify-content-center align-items-center">
            <form className="form px-4 py-3">
              ...
              <div className="form-group">
                <p className="mt-4">
                  2.1. Каждая страница работы вложена в отдельный файл?
                </p>
                <input
                  type="radio"
                  id="question-5__answer-1"
                  name="question-5"
                  value="Да, каждая"
                />
                <span className="margin" />
                <label htmlFor="question-5__answer-1">Да, каждая</label>
                <br />
                <input
                  type="radio"
                  id="question-5__answer-2"
                  name="question-5"
                />
                <span className="margin" />
                <label htmlFor="question-5__answer-2">Нет, ни одна</label>
                <br />
              </div>
              ...
              <div className="form-group">
                ...
                <input
                  type="radio"
                  id="question-6__answer-1"
                  name="question-6"
                />
                <span className="margin" />
                <label htmlFor="question-6__answer-1">Да</label>
                <br />
                <input
                  type="radio"
                  id="question-6__answer-2"
                  name="question-6"
                />
                <span className="margin" />
                <label htmlFor="question-6__answer-2">Нет</label>
                <br />
              </div>

              <div className="form-group">
                <p className="mt-4">
                  2.3. Работа оформлена шрифтом Times New Roman, 14 кегль, с
                  интервалом между строк 1,5?
                </p>
                <input
                  type="radio"
                  id="question-7__answer-1"
                  name="question-7"
                />
                <span className="margin" />
                <label htmlFor="question-7__answer-1">Да</label>
                <br />
                <input
                  type="radio"
                  id="question-7__answer-2"
                  name="question-7"
                />
                <span className="margin" />
                <label htmlFor="question-7__answer-2">Нет</label>
                <br />
              </div>
