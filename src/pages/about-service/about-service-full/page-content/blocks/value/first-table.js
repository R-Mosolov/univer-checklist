        ...
        <table className="table">
          ...
          <tbody>
            ...
            <tr>
              <td>2.3</td>
              <td>
                Работа оформлена шрифтом Times New Roman, 14 кегль, с интервалом
                между строк 1,5?
              </td>
            </tr>
            <tr>
            ...
            <tr>
              <td>4.2</td>
              <td>
                Название работы ограничивает исследование локально? Например,
            ...
            <tr>
              <td>4.3</td>
              <td>
                Названия отдельных глав более узки по смыслу, чем название
                (тема) работы?
              </td>
            </tr>
            <tr>
            ...
            <tr>
              <td>5.2</td>
              <td>
                Названия разделов выделены жирным шрифтом и написаны прописными
                буквами?
              </td>
            </tr>
            <tr>
              <td>5.3</td>
              <td>
                Все смысловые блоки работы включены в содержание? Например,
            ...
            <tr>
              ...
              <td>
                ...
                исследования, объект, предмет, цель, задачи, степень научной
                разработанности, список авторов?
              </td>
            </tr>
            <tr>
              <td>6.2</td>
            ...
            <tr>
              <td>6.3</td>
              <td>
                Задачи, которые прописаны во введении, упоминаются в др. главах
                работы как реализованные?
              </td>
            </tr>
            <tr>
              ...
              <td>
                ...
                классиков научного направления, на которое Вы опираетесь?
              </td>
            </tr>
            <tr>
              <td>7.2</td>
              <td>
                В сносках внизу текста ФИО авторов подчеркнуты курсивным
                шрифтом?
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td>
                ...
                первичных данных, собранных в ходе исследования?
              </td>
            </tr>
            <tr>
              <td>8.2</td>
            ...
            <tr>
              <td>9.3</td>
              <td>
                В заключении дан список рекомендаций на основе изученных и
                собранных данных?
              </td>
            </tr>
            <tr>
            ...
            <tr>
              <td>10.2</td>
              <td>
                При оформлении списка литературы ФИО автора выделены жирным
                шрифтом?
              </td>
            </tr>
            <tr>
              <td>10.3</td>
              <td>
                Если авторов какой-либо работы в списке литературы больше, чем
                один, то стоит дополнение «и др.»?
              </td>
            </tr>
            <tr>
            ...
            <tr>
              <td>11.2</td>
              <td>
                Изображения в приложении имеют высокое качество для печати (300
                dpi)?
              </td>
            </tr>
            <tr>
              <td>11.3</td>
              <td>
                Изображения в приложении подписаны согласно стандарту ГОСТ
                (далее версия ГОСТ-а. – Р.М.)?
              </td>
            </tr>
          </tbody>
        </table>
