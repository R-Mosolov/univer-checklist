        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          <ul className="navbar-nav mr-auto">
            ...
            <li className="nav-item dropdown">
              <Link
                className="about-service-entrypoint m-0 p-0"
                to="/about-service-base"
              >
                <a
                  className="nav-link dropdown-toggle"
                  href="/about-service-base"
              ...
              <div className="dropdown-menu">
                <Link className="dropdown-item" to="/about-service-base">
                  Кратко
                </Link>
                <Link className="dropdown-item" to="/about-service-full">
                  Подробно
                </Link>
              </div>
            </li>
          ...
          <form className="form-inline my-2 my-lg-0">
            <div className="mr-2 btn-group">
              ...
              >
                <span className="small-letter">А-</span>
              </button>
              <button
              ...
              >
                <span className="normal-letter">А</span>
              </button>
              <button
                className="button-font-size font-zoom-up btn my-2 my-sm-0"
                type="button"
                onClick={zoomUpFonts}
              >
                <span className="big-letter">А+</span>
              </button>
            </div>
            <button
              id="night-mode"
